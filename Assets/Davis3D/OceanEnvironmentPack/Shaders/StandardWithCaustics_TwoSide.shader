...
Shader "FI/OEP/StandardWithCausticsTwoSide"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float GetCaustics96_g2( sampler2D CausticsMap, sampler2D FlowMap, float GlobalScale, float CausticsScale_1, float CausticsScale_2, float CausticsScale_3, float FlowMapScale_1, float FlowMapScale_2, float FlowMapScale_3, float GlobalSpeed, float CausticsSpeed_1, float CausticsSpeed_2, float CausticsSpeed_3, float3 worldNormal, float localIntensity, float localScale, float CausticsWave1_Multiply, float2 uv, float FlowMapIntensity )
			{
						 ...
						 ) : SV_Target
			{
				...
				sampler2D CausticsMap96_g2 = _CausticsMap;
				sampler2D FlowMap96_g2 = _FlowMap;
				float GlobalScale96_g2 = _GlobalScale;
				float CausticsScale_196_g2 = _CausticsScale_1;
				float CausticsScale_296_g2 = _CausticsScale_2;
				float CausticsScale_396_g2 = _CausticsScale_3;
				float FlowMapScale_196_g2 = _FlowMapScale_1;
				float FlowMapScale_296_g2 = _FlowMapScale_2;
				float FlowMapScale_396_g2 = _FlowMapScale_3;
				float GlobalSpeed96_g2 = _GlobalSpeed;
				float CausticsSpeed_196_g2 = _CausticsSpeed_1;
				float CausticsSpeed_296_g2 = _CausticsSpeed_2;
				float CausticsSpeed_396_g2 = _CausticsSpeed_3;
				float3 worldNormal96_g2 = WorldNormal;
				float localIntensity96_g2 = _CausticsIntensity;
				float localScale96_g2 = _CausticsScale;
				float CausticsWave1_Multiply96_g2 = _CausticsWave1_Multiply;
				float2 appendResult106_g2 = (float2(WorldPosition.x , WorldPosition.z));
				float2 uv96_g2 = appendResult106_g2;
				float FlowMapIntensity96_g2 = _FlowMapIntensity;
				float localGetCaustics96_g2 = GetCaustics96_g2( CausticsMap96_g2 , FlowMap96_g2 , GlobalScale96_g2 , CausticsScale_196_g2 , CausticsScale_296_g2 , CausticsScale_396_g2 , FlowMapScale_196_g2 , FlowMapScale_296_g2 , FlowMapScale_396_g2 , GlobalSpeed96_g2 , CausticsSpeed_196_g2 , CausticsSpeed_296_g2 , CausticsSpeed_396_g2 , worldNormal96_g2 , localIntensity96_g2 , localScale96_g2 , CausticsWave1_Multiply96_g2 , uv96_g2 , FlowMapIntensity96_g2 );
				
				float3 Albedo = ( _Color * tex2D( _MainTex, uv_MainTex ) ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _NormalTex, uv_NormalTex ), 1.0f );
				float3 Emission = ( _EmissiveColor + localGetCaustics96_g2 ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 worldNormal96_g2 = ase_worldNormal;
				float localIntensity96_g2 = _CausticsIntensity;
				float localScale96_g2 = _CausticsScale;
				float CausticsWave1_Multiply96_g2 = _CausticsWave1_Multiply;
				float2 appendResult106_g2 = (float2(WorldPosition.x , WorldPosition.z));
...
/*ASEBEGIN
Version=18900
1536;72;1142;657;1282.462;467.7053;1.3;True;False
...
Node;AmplifyShaderEditor.ColorNode;4;-764.3831,257.7913;Inherit;False;Property;_EmissiveColor;Emissive Color;8;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-765.3831,-223.2087;Inherit;True;Property;_MainTex;Main Tex;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;12;-764.8046,458.0449;Inherit;False;GlowWaves;0;;2;5c3820833cf4f694b98bdc169aaa0e35;0;0;1;FLOAT;99
Node;AmplifyShaderEditor.RangedFloatNode;11;-765.2625,562.2356;Inherit;False;Property;_Metallic;Metallic;7;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-765.7099,670.0256;Inherit;False;Property;_Glossiness;Smoothness;6;0;Create;False;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;-52.53294,-407.6492;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;FI/OEP/StandardWithCausticsTwoSide;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=E277CA230C1CC63FCD51B1E1F1DCF1EE259BC514