...
Shader "FI/OEP/TwoGradientsWithCaustics"
{
	Properties
	{
		...
		[ASEEnd]_Metallic2("Metallic", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_NormalDetailTex = IN.ase_texcoord7.xy * _NormalDetailTex_ST.xy + _NormalDetailTex_ST.zw;
				...
				float3 Albedo = ( ( _Color * temp_output_5_0 ) + ( ( 1.0 - temp_output_5_0 ) * _Color2 ) ).rgb;
				float3 Normal = BlendNormal( UnpackNormalScale( tex2D( _NormalTex, uv_NormalTex ), 1.0f ) , UnpackNormalScale( tex2D( _NormalDetailTex, uv_NormalDetailTex ), 1.0f ) );
				float3 Emission = temp_cast_1;
				float3 Specular = 0.5;
				float Metallic = _Metallic2;
				float Smoothness = _Glossiness2;
				float Occlusion = 1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18900
1536;72;1142;657;1743.674;187.8897;2.137143;True;False
...
WireConnection;18;2;1;99
WireConnection;18;3;14;0
WireConnection;18;4;15;0
ASEEND*/
//CHKSM=FC3411EAD08F1EF380963C7168CC04A08BF5B7A2